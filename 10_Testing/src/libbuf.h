/* libbuf.h --- growable memory buffers for C99
...
#define buf_grow1(v, esize, n) __buf_grow1(v, esize, n, BUF_ABORT)
...
void *
__buf_grow1(void *v, size_t esize, ptrdiff_t n, void(*abortFuncPtr)(void));
